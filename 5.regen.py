...
GENESIS_ARCHIVE = "new-export.json"
...
ks_val = Validator()
ks_val.self_delegation_address = "regen1s0lankh33kprer2l22nank5rvsuh9ksap3qcst"
ks_val.self_delegation_public_key = "A3beVgIqq0m2at7sDUoMklta4CMjRkqR69M0LpS0l/Hf"
ks_val.operator_address = "regenvaloper1s0lankh33kprer2l22nank5rvsuh9ksaakaag6"
ks_val.public_key = "YkMQfckILjJkTrDbeJItcebMgp/F1z4xhZfsFLKh7mw="
ks_val.address = "38A7BF4DCC835FF7AC37E4686AC1907CEFE88670"
ks_val.consensus_address = "regenvalcons18znm7nwvsd0l0tphu35x4svs0nh73pnsgtqmv8"
...
fi_val = Validator()
fi_val.self_delegation_address = "regen1shamuuzg9aqskml0udx43xq9kg2h4ekdzzmja6"
fi_val.self_delegation_public_key = "AyRczyHfzKP4WcVxZibpKI19qMnt7SMVxQP3FR6Kx77A"
fi_val.operator_address = "regenvaloper1shamuuzg9aqskml0udx43xq9kg2h4ekd79xh9t"
fi_val.public_key = "PkTD7ugvS5/m/O9UygeX9yJtRxDGn2hTL/Y46c6m8uc="
fi_val.address = "1F867B73234E5893348CCD0ACE15B72718AB971A"
fi_val.consensus_address = "regenvalcons1r7r8kuerfevfxdyve59vu9dhyuv2h9c62u2h8f"
...
gentink.add_task(gentink.replace_validator,
                 old_validator=ks_val,
                 new_validator=fi_val)
...
gentink.add_task(gentink.increase_validator_power,
		 operator_address='regenvaloper1qwa9xy0997j5mrc4dxn7jrcvvkpm3uwur2txre',
		 validator_address='FA93C9682445DA618F81465AAE6D8B1729A8F939',
		 power_increase=23354076000000)

gentink.add_task(gentink.increase_validator_power, 
                 operator_address='regenvaloper132hlyt0uwnl6sy9esrerdf0gtmhex6eptlh7k3', 
                 validator_address='8D9FA05784C4D715EC1992053F7A24C4AB90EED4', 
                 power_increase=23354076000000)

gentink.add_task(gentink.increase_validator_power, 
                 operator_address='regenvaloper108fuazrugwhvf9sxknn2r5nyv24vaeta95dp0f', 
                 validator_address='B5A2BC28ECBB45F73FA27305A07BDBE36DD497E3', 
                 power_increase=23354076000000)

gentink.add_task(gentink.increase_validator_power, 
                 operator_address='regenvaloper1j0wl83ulvwancndjg5jp3r5l2m8jq0faaq6uk7', 
                 validator_address='7C61A4FE055AE13E61BE936CCA58CFFDA031D33B', 
                 power_increase=23354076000000)
